...
export const SparklesIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.542L16.5 21.75l-.398-1.208a3.375 3.375 0 00-2.456-2.456l-1.208-.398 1.208-.398a3.375 3.375 0 002.456-2.456l.398-1.208.398 1.208a3.375 3.375 0 002.456 2.456l1.208.398-1.208.398a3.375 3.375 0 00-2.456 2.456z" />
    </svg>
);
...
export const EyeSlashIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.754 0 8.774 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.894 7.894L21 21m-3.228-3.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.243 4.243L6.228 6.228" />
    </svg>
);
...
export const RectangleGroupIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 7.125A2.25 2.25 0 014.5 4.875h15A2.25 2.25 0 0121.75 7.125v10.5A2.25 2.25 0 0119.5 19.875h-15A2.25 2.25 0 012.25 17.625V7.125z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 7.125v-1.5A2.25 2.25 0 014.5 3.375h15A2.25 2.25 0 0121.75 5.625v1.5" />
    </svg>
);
...
export const UserGroupIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.513-.96 1.487-1.591 2.571-1.82m9.19-2.812a8.962 8.962 0 01-1.591 6.32m-15.4-6.32v-3.532c0-.97.788-1.75 1.75-1.75h1.5a1.75 1.75 0 011.75 1.75v3.532m-7.375 2.186a2.25 2.25 0 012.25-2.25h9.75a2.25 2.25 0 012.25 2.25v2.25a2.25 2.25 0 01-2.25 2.25H6.75a2.25 2.25 0 01-2.25-2.25v-2.25z" />
    </svg>
);
...
export const BellAlertIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.31 5.632l-1.32.88A2.882 2.882 0 001.332 19.5a2.882 2.882 0 002.833 2.833h13.67a2.882 2.882 0 002.832-2.833 2.882 2.882 0 00-1.332-2.418zM12 18.75a.75.75 0 01.75.75v.008c0 .414-.336.75-.75.75h-.008a.75.75 0 01-.75-.75v-.008c0-.414.336.75.75-.75h.008zM12 4.5a.75.75 0 01.75.75v4.5a.75.75 0 01-1.5 0V5.25A.75.75 0 0112 4.5z" />
  </svg>
);

export const PaintBrushIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 21.34a1.5 1.5 0 001.06-.44l4.42-4.42a1.5 1.5 0 00.44-1.06V7.5a1.5 1.5 0 00-1.5-1.5h-1.88a1.5 1.5 0 01-1.06-.44l-4.42-4.42a1.5 1.5 0 00-2.12 0l-4.42 4.42A1.5 1.5 0 013 7.5v7.38a1.5 1.5 0 00.44 1.06l4.42 4.42a1.5 1.5 0 001.06.44h4.5z" />
...
export const ArrowRightOnRectangleIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 8.25h9m-9 3H12m2.25 2.25h4.5m-16.5 0A2.25 2.25 0 013.75 12h16.5a2.25 2.25 0 012.25 2.25v3.75A2.25 2.25 0 0118 20.25H6A2.25 2.25 0 013.75 18v-2.25A2.25 2.25 0 011.5 13.5v-1.5A2.25 2.25 0 013.75 9.75h16.5a2.25 2.25 0 012.25 2.25" />
    </svg>
);
...
export const MegaphoneIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 21l5.25-11.25L21 21m-9.486-3.375h.008v.008h-.008v-.008zm0 0c.091.01.183.018.275.026l3.386-7.252c.24- .513.784-.826 1.355-.826H21m-3.375 0h.008v.008h-.008v-.008zM3.75 6.375c.621 0 1.125.504 1.125 1.125v4.5c0 .621-.504 1.125-1.125 1.125H3.75v-6.75z" />
    </svg>
);
