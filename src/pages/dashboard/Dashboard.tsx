...
import RecentActivities from "../../components/dashboard/charts/RecentActivities";
  ...
  <div className="space-y-8 animate-fade-in-up">
    <div className="bg-card p-8 rounded-xl shadow-lg text-center">
      ...
      <h1 className="mt-4 text-4xl font-bold text-text-primary">
        Find Your Next Property with RE-CRM Pro
      </h1>
      <p className="mt-2 text-lg text-text-secondary max-w-2xl mx-auto">
        Browse our extensive list of available properties. Sign up to save your
        favorites, manage your interests, and schedule viewings seamlessly.
      </p>
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link
          to="/my-interests"
          className="bg-card p-6 rounded-xl shadow-soft flex items-center space-x-4 hover:bg-gray-700/50 transition-colors hover:-translate-y-1 hover:shadow-lg"
        >
          <SparklesIcon className="h-10 w-10 text-primary" />
          <div>
            <h2 className="text-xl font-semibold">My Interests</h2>
            <p className="text-text-secondary">
              Manage your property preferences.
            </p>
          </div>
        </Link>
        <Link
        ...
        >
          ...
          <div>
            ...
            <p className="text-text-secondary">
              View your appointments and pipeline.
            </p>
          </div>
        </Link>
      </div>
...
const InternalUserDashboard: React.FC = () => {
  ...
  const dashboardTitle =
    user?.role === UserRole.AGENT ? "Agent Dashboard" : "Admin Dashboard";
